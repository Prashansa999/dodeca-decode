...
window.QUESTIONS = {
  ...
  "07-03": {
    ...
    explanation: "Novak Djokovic won his first Wimbledon title, beating defending champion Rafael Nadal in the final (1), 6-4, 6-1, 1-6, 6-3 (2), ending Nadal's 20-match Wimbledon winning streak (3). It was Djokovic's first title on grass (4), capping a season that had opened with a stunning 41-0 start (5) and now delivered his third major overall (6). He had already secured the world No. 1 ranking before the final even began, by winning his semifinal against Jo-Wilfried Tsonga (7), and the match was played at the All England Club (8), securing his first Wimbledon crown (9). Djokovic was born in Belgrade, Serbia (10), and is nicknamed 'the Djoker' (11). He would go on to hold the world No. 1 ranking for a record 428 weeks (12)."
  },
  "07-04": {
    category: "History",
    year: 1776,
